...
//
//     @Autowired
//     private IManageAppointmentRequest appointmentService;
//
//     @Autowired
//     private IAppointmentNotification appointmentNotification;
//
...
//
//            appointmentNotification.sendAppointmentReminder(patientEmail, doctorName, appointmentTime);
//
...
public class ReminderScheduler {
    ...
    public void sendReminders() {
        ...
        List<Appointment> upcomingAppointments = appointmentManager.getAppointmentsForReminders(now, reminderTime);
